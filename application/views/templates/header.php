...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
                <title>ActividadesAdminisrtativasYApoyoAOficinas</title>
...
<header class="main-header">
    ...
    <a href="<?php echo site_url('/main'); ?>" class="logo">
      ...
      <span class="logo-mini"><b>PA</b>SA</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">ActividadesAdminisrtativasYApoyoAOficinas</span>
    </a>
